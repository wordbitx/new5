...
export function Hero() {
  ...
  return (
    <section 
      ref={sectionRef}
      id="home" 
      className="relative min-h-screen bg-[#1B1B5C] overflow-hidden pt-24 md:pt-32"
      style={{
        background: 'radial-gradient(circle at 38% 45%, rgba(123,63,228,0.18), transparent 55%), #1B1B5C'
      }}
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center min-h-[calc(100vh-8rem)]">
          ...
          <div ref={contentRef} className="relative z-10 py-12 lg:py-0">
            ...
            <h1 className="animate-item text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold text-white leading-[0.95] mb-6">
              ...
              <span className="text-gradient">work as hard</span>{' '}
              as you do.
            </h1>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              {features.map((feature, index) => (
                ...
                >
                  <feature.icon className="w-5 h-5 text-[#7B3FE4]" />
          ...
          <div className="relative flex items-center justify-center lg:justify-end">
            ...
            {/* Decorative Elements */}
            <div className="absolute -bottom-8 -left-8 w-32 h-32 bg-[#7B3FE4]/20 rounded-full blur-2xl" />
            <div className="absolute -top-8 -right-8 w-40 h-40 bg-[#7B3FE4]/10 rounded-full blur-3xl" />
          </div>
        </div>
      </div>

      {/* Bottom Gradient */}
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#1B1B5C] to-transparent" />
    </section>
  );
}
