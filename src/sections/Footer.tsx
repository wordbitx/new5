...
export function Footer() {
  ...
  const footerLinks = {
    ...
    categories: [
      { name: 'Social Media', href: '#all-products' },
      { name: 'Virtual Services', href: '#services' },
      { name: 'Dev Kits', href: '#all-products' },
      { name: 'Ebooks', href: '#all-products' },
      { name: 'Kids Learning', href: '#all-products' },
    ]
  };
  ...
  return (
    <footer id="legal" className="bg-[#1B1B5C] text-white">
      {/* Main Footer */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#7B3FE4] to-[#9b6af0] flex items-center justify-center font-bold text-xl shadow-lg">
                <svg viewBox="0 0 24 24" className="w-7 h-7 text-white" fill="currentColor">
                  <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>
                </svg>
              </div>
              <div>
                <div className="font-bold text-lg">THRIVE CODE</div>
            ...
            <div className="flex gap-3">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#7B3FE4] transition-colors"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-white/60 text-sm text-center md:text-left">
              {currentYear} THRIVE CODE LLC. All rights reserved.
            </p>
            <p className="text-white/60 text-sm">
              Website:{' '}
              <a 
                href="https://thrivecodellc.com" 
